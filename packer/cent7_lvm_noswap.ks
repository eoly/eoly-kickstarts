...
logvol / --vgname vg_root --name lv_root --fstype=xfs --size=2048 --grow
logvol /tmp --vgname vg_root --name lv_tmp --fstype=xfs --size=2048 --maxsize=4096 --grow --fsoptions="nodev,nosuid,noexec"
logvol /var/log --vgname vg_root --name lv_var_log --fstype=xfs --size=1024 --grow
logvol /var/log/audit --vgname vg_root --name lv_var_log_audit --fstype=xfs --size=1024 --grow
logvol /home --vgname vg_root --name lv_home --fstype=xfs --size=500 --maxsize=10240 --grow --fsoptions="nodev" 
logvol /var --vgname vg_root --name lv_var --fstype=xfs --size=2048 --grow
EOF
%end
